---
aliases: ["Kitchen Strategy Masterclass (Universal Rackets)"]
...
- **Two drills to hold your dinks.** (1) Move back like you're going to speed up, then dink instead; (2) Same setup, but wait until the last possible instant to commit direction. This makes dinks look like speed-ups, removing anticipation from your opponent.
...
- **Block volley on aggressive dinks: paddle out, laser open, squeeze.** When a ball is coming fast and deep — too fast to move back — squeeze grip slightly, open paddle face so the laser points up, and simply redirect it.
