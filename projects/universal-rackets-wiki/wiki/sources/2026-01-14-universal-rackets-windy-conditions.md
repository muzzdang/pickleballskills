---
aliases: ["How to Play Pickleball in Windy Conditions (Universal Rackets)"]
...
# How to Play Pickleball in Windy Conditions (Universal Rackets)
...
- **Lob strategy when opponents hate the wind.** High, slow balls are maximally affected by wind. If opponents are struggling mentally: lob them. The ball will move unpredictably and they'll self-destruct.
...
- [Footwork System](../concepts/footwork-system.md) — adjustment steps
- [Error Reduction](../concepts/error-reduction.md) — wind strategy
