---
aliases: ["4 Strategies for Beginners to Win More Points (Universal Rackets)"]
...
- **The one mistake the "beginner" video identifies:** standing still after hitting. Every shot must be accompanied by forward movement.
...
Both Tyler and Michele demo all four scenarios. Tyler demonstrates the "serve-and-run-up" mistake — showing that running up immediately gets the ball hit at your feet when it's still in the air (double-bounce violation).
